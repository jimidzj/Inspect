...
namespace GENLSYS.MES.WCF
{
    ...
    public class wsPAD : IwsPAD
    {
        ...
        //201306 George --Begin
        //空箱Move by carton
        public bool MoveBoxSaveDummyCarton(string _customerid, string _poid, string _cartonNumber, ContextInfo contextInfo)
        {

            contextInfo.Action = MES_ActionType.Query;
            GENLSYS.MES.Services.Inspection.INP.AssyBoxBll bll = new GENLSYS.MES.Services.Inspection.INP.AssyBoxBll(contextInfo);
            bll.CallAccessControl();
            bool rs = bll.MoveBoxSaveDummy(_customerid, _poid, _cartonNumber, contextInfo.CurrentUser, contextInfo.WorkGroup);
            GC.Collect();
            return rs;
        }
        //201306 George --End
