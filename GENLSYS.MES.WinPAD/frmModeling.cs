...
using GENLSYS.MES.WinPAD.MDL;
using GENLSYS.MES.WinPAD.SYS;
...
using GENLSYS.MES.WinPAD.SYS.UpgradeAssistant;
...
namespace GENLSYS.MES.WinPAD
{
    public partial class frmModeling : Form
    {
        ...
        private void frmModeling_Load(object sender, EventArgs e)
        {
            ...
            this.Text = UtilCulture.GetString("Label.R03001") + " @ " + ConfigReader.getApplicationName() + "[" + ConfigReader.getCurrentRevision() + "]" +
                " - " + ConfigReader.getCustomerName() + " - " + ConfigReader.getEnvironmentName() ;
