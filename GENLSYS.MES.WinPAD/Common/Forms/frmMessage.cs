...
namespace GENLSYS.MES.WinPAD.Common.Forms
{
    public partial class frmMessage : Form
    {
        ...
        public void ShowMessage(string msgHeader, string msgContext,
           Public_MessageBox msgBox, MessageBoxButtons msgButtons, string[] butText)
        {
            this.lblMsg.Text = msgHeader;
            this.txtMessage.Text = msgContext;

            SetFace(msgBox,msgButtons,butText);
        }
        ...
        private void SetFace(Public_MessageBox msgBox, MessageBoxButtons msgButtons ,string[] butText)
        {
            SetFace(msgBox, msgButtons);
            ResetButton(msgButtons, butText);
        ...
        private void ResetButton(MessageBoxButtons msgButtons, string[] butText)
        {
            if (msgButtons == MessageBoxButtons.OK)
            {
                this.btn1.Text = butText[0];
                this.btn1.Visible = true;
                this.btn2.Visible = false;
