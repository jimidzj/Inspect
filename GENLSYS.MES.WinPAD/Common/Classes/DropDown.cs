    ...
    public class DropDown
    {
        ...
        public static void InitCMB_ReasonCategory_All(ComboBox cmd)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < lstReasonCategory.Count; i++)
                {
                    cmd.Items.Add(new ValueInfo()
                    {
                        DisplayField = lstReasonCategory[i].reasoncategory,
                        ValueField = lstReasonCategory[i].reasoncategory
                    });
                }
            }
            catch (Exception ex)
        ...
        public static void InitCMB_Employee_Valid(ComboBox cmd)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < lseEmployee.Count; i++)
                {
                    cmd.Items.Add(new ValueInfo()
                    {
                        DisplayField = lseEmployee[i].employeeid + "(" + lseEmployee[i].employeename + ")",
                        ValueField = lseEmployee[i].employeeid
                    });
                }
            }
            catch (Exception ex)
        ...
        public static void InitCMB_WorkGroup(ComboBox cmb)
        {
            ...
            try
            {
                ...
                foreach (tmdlworkgroup workgroup in lstShift)
                {
                    cmb.Items.Add(new ValueInfo()
                    {
        ...
        public static void InitCMB_AttributeTemplate_All(ComboBox cmb, MES_AttributeTemplate_UsedBy usedBy)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < lstArrtibueteTemplate.Count; i++)
                {
                    cmb.Items.Add(new ValueInfo()
                    {
                        DisplayField = lstArrtibueteTemplate[i].attrtplatname,
                        ValueField = lstArrtibueteTemplate[i].attrtplatid
                    });
                }
            }
            catch (Exception ex)
        ...
        public static void InitCMB_EmployeeType_All(ComboBox cmb)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < lstemtype.Count; i++)
                {
                    cmb.Items.Add(new ValueInfo()
                    {
                        DisplayField = lstemtype[i].employeetypename,
                        ValueField = lstemtype[i].employeetypeid
                    });
                }
            }
            catch (Exception ex)
        ...
        public static ValueListItem[] GetValueList_ReasonCode(MES_ReasonCategory reasonCategory)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < lstReasonCode.Count; i++)
                {
                    ValueListItem item = new ValueListItem()
                    {
                        DisplayText = lstReasonCode[i].reasoncodedesc,
                        DataValue = lstReasonCode[i].reasoncode
                    };
                    lstVL.Add(item);
                }
                return lstVL.ToArray<ValueListItem>();
        ...
        public static ValueListItem[] GetValueList_Customer_All()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < lstCustomer.Count; i++)
                {
                    ValueListItem item = new ValueListItem()
                    {
                        DisplayText = lstCustomer[i].customername,
                        DataValue = lstCustomer[i].customerid
                    };
                    lstVL.Add(item);
                }
                return lstVL.ToArray<ValueListItem>();
