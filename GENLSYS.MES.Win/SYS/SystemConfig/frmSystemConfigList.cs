...
{
    public partial class frmSystemConfigList : Form
    {
        ...
        #region Events
        private void frmSystemConfigList_Load(object sender, EventArgs e)
        {
        ...
        private void ucToolbar1_EditEventHandler(object sender, EventArgs e)
        {
            ...
            frmSystemConfigEdit f = new frmSystemConfigEdit();
