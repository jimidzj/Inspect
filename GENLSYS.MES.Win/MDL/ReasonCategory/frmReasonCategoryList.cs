...
{
    public partial class frmReasonCategoryList : Form
    {
        ...
        #region Events
        private void frmReasonCategoryList_Load(object sender, EventArgs e)
        {
        ...
        private void ucToolbar1_EditEventHandler(object sender, EventArgs e)
        {
            ...
            lstParameters.Add(new MESParameterInfo()
            {
                ...
                ParamValue = this.grdQuery.ActiveRow.Cells["reasoncategory"].Value.ToString(),
                ParamType = "string"
            });

            frmReasonCategoryEdit f = new frmReasonCategoryEdit();
        ...
        {
            e.Layout.Bands[0].Columns["attrtplatid"].Hidden = true;
        }
        #endregion
        ...
        private void GetData(List<MESParameterInfo> lstParameters)
        {
            ...
            try
            {
                ...
                DataSet ds = client.GetReasonCategoryRecords(baseForm.CurrentContextInfo, lstParameters.ToArray<MESParameterInfo>());
        ...
        public void DoDelete()
        {
            ...
            DialogResult result = baseForm.CreateMessageBox(Public_MessageBox.Question,
                        ...
                        "" + UtilCulture.GetString("Label.R00038") + ": " 
                            + this.grdQuery.ActiveRow.Cells["reasoncategory"].Value.ToString());
            ...
            try
            {
                ...
                client.DoDeleteReasonCategory(baseForm.CurrentContextInfo, lstParameters.ToArray<MESParameterInfo>());
